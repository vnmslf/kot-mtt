...
class Version20240806200203 extends Version
{
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Первая секция (мобайл)',
  'ACTIVE' => 'Y',
  'SORT' => '2',
  'CODE' => 'FIRST_SECTION_MOBILE',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'F',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Изображение на курсе будет',
  'ACTIVE' => 'Y',
  'SORT' => '4',
  'CODE' => 'ON_THIS_COURSE',
  'DEFAULT_VALUE' => '',
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Во время курса ты изучишь',
  'ACTIVE' => 'Y',
  'SORT' => '8',
  'CODE' => 'INTIME',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Название курса для главной страни цы (опционально)',
  'ACTIVE' => 'Y',
  'SORT' => '10',
  'CODE' => 'MAIN_NAME',
  'DEFAULT_VALUE' => '',

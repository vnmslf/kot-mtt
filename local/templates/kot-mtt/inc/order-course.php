...
<form name="<?=$prefix?>-main" class="class active <?=$prefix?>-main" action="<?=SITE_TEMPLATE_PATH?>/inc/form.php" method="post" enctype="multipart/form-data">
	<h2>
		<span>Группа закрывается после набора 25&nbsp;человек, успейте занять свое место!</span>
		<img src="<?=SITE_TEMPLATE_PATH?>/images/hot.svg" alt="Торопитесь!" />
	</h2>
	<div class="form-section">
		...
		<div class="form-group">
			<label>Юзернейм Telegram / WhatsApp <span>*</span></label>
			<input type="text" name="<?=$prefix?>-social" id="<?=$prefix?>-social" class="required" value="" placeholder="@telegram или +7 (111) 111 11 11" />
		</div>
		<div class="form-group">
			<label>E-mail</label>
	...
	<div class="background__data">
		<img class="mob" src="<?=SITE_TEMPLATE_PATH?>/images/hot__back-mob.svg" alt="Торопитесь!" />
		<img class="pc" src="<?=SITE_TEMPLATE_PATH?>/images/hot__back-pc.svg" alt="Торопитесь!" />
	</div>
</form>
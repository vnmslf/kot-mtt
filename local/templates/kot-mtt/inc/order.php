...
<form name="<?=$prefix?>-main" class="class" action="<?=SITE_TEMPLATE_PATH?>/inc/form.php" method="post" enctype="multipart/form-data">
	<div class="form-section">
		<div class="form-group">
			...
			<input type="text" name="<?=$prefix?>-name" id="<?=$prefix?>-name" class="form-control form-control-lg required" value="" placeholder="Прим. Дмитрий" />
		</div>
		<div class="form-group">
			<label>Телефон <span>*</span></label>
			<input type="tel" name="<?=$prefix?>-phone" id="<?=$prefix?>-phone" class="masked__phone form-control form-control-lg required" value="" placeholder="+7 (111) 111 11 11" maxlength="12" />
		</div>
		<div class="d-none">
